...
if __name__=="__main__":
    ...
    if not os.path.exists('experiment_data'):
        ...
        print('made directory:' + 'experiment_data' + ' for experiment')
    ...
    try:
        ...
        while time() - start_time < duration:            
            ...
            if current_time >= next_print_time:
                ...
                state = controller._normalize_gaze_to_category(gaze_score)
                save_dictionary['gaze_score_timestep_'+str(time_step_count)] = gaze_score
                save_dictionary['gaze_state_timestep_'+str(time_step_count)] = state
            ...
            save_DGEI_data('experiment_data', time_now, save_dictionary)
